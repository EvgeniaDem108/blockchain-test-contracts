...
```ethers.js - это JavaScript/TypeScript библиотека, которая позволяет:
Подключаться к блокчейну Ethereum (или совместимым сетям)
Взаимодействовать со смарт-контрактами
Управлять кошельками и аккаунтами
